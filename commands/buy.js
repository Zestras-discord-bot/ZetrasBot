...
const productLimitedItemsAccounts =[
    {
        "name": "CALL OF DUTY®: MW  | 11+ Obsidian Weapons w/ 26 Platinum Weapons + 31 Gold Weapons ",
        "price": 17.99 * ppPrice
    },
    {
    ...
    {
        "name": "CALL OF DUTY®: MW  | Damascus Camo w/ 5+ Obsidian Weapons | Email Access",
        "price": 31.99 * ppPrice
    },
    {
        "name": "CALL OF DUTY®: MW  | Damascus Camo + 30 Obsidian Weapons + Max Battle Pass (2-6) | Email Access",
        "price": 89.99 * ppPrice
    },
...
module.exports = {
    async "run" (discord, bot, message, args) {
        ...
        {      
            message.delete()
            return message.reply('This is not the right section for this command, Go and create a ticket').then(message => {setTimeout(()=>{message.delete()},5000)})
        }

        let ticket = message.channel ;

        message.reply(new discord.MessageEmbed().setTitle(`Hello, ${message.author.username}!`).setDescription("*What payment method would you like to use to pay?*\n\n**[1]** *PayPal*\n\n**[2]** *Bitcoin*\n\n**NOTE:** Type `-close` to close the ticket at any time.").setColor(0x36393E));
        ...
        paymentMethodCollector.on("collect", (message) => {
            ...
            if(paymentMethodContent === "bitcoin" || paymentMethodContent === "2") return ticket.send("*If you want to purchase using Bitcoin, then please buy here using our website* **http://zestras.net/**\n\n**NOTE:** Type `-close` to close the ticket at any time.") && paymentMethodCollector.stop();
                ...
                const acceptedTermsCollector = ticket.createMessageCollector(x => true);
                ...
                acceptedTermsCollector.on("collect", (message) => {
                    ...
                    if(acceptedTermsContent === "no" || acceptedTermsContent === "2") return ticket.delete() && acceptedTermsCollector.stop();
                        ...
                        message.channel.send(new discord.MessageEmbed().setTitle("What are you looking for ??").setDescription("*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n**[1]** *Accounts*\n\n**[2]** *Services*\n\n**NOTE:** Type `-close` to close the ticket at any time.").setColor(0x36393E));
                        
                        const whatLookingForCollector = ticket.createMessageCollector(x => true);
                        ...
                        whatLookingForCollector.on("collect", (message) => {
                            ...
                            if(collectorContent === "service" || collectorContent === "2") {
                                whatLookingForCollector.stop()
                                    message.channel.send(new discord.MessageEmbed().setTitle("Which Service ?").setDescription("*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n**[1]** *Instagram*\n\n**[2]** *YouTube*\n\n**[3]** *Twitch*\n\n**[4]** *Spotify*\n\n**NOTE:** Type `-close` to close the ticket at any time.").setColor(0x36393E));
                                    const whichServiceCollector = ticket.createMessageCollector(x => true);
                                    whichServiceCollector.on("collect",(message)=>{
                                        collectorContent = message.content.toLowerCase(); 
                                        
                                        if(collectorContent === "instagram" || collectorContent === "1"){
                                            
                                            whichServiceCollector.stop()
                                            
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productInstagramServices.map(product =>`**[${productInstagramServices.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                else if(number < 1 || number > productInstagramServices.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                            ...
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productYouTubeServices.map(product =>`**[${productYouTubeServices.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productYouTubeServices.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
                                            ...
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productTwitchServices.map(product =>`**[${productTwitchServices.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productTwitchServices.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
                                            ...
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productSpotifyServices.map(product =>`**[${productSpotifyServices.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productSpotifyServices.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
                                ...
                                message.channel.send(new discord.MessageEmbed().setTitle("Which Account").setDescription("*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n**[1]** *Limited Items*\n\n**[2]** *Call of Duty*\n\n**[3]** *Food*\n\n**[4]** *Vpn*\n\n**[5]** *Others*\n\n**NOTE:** Type `-close` to close the ticket at any time.").setColor(0x36393E));
                                    ...
                                    whichServiceCollector.on("collect",(message)=>{
                                        ...
                                        if(collectorContent === "limited items" || collectorContent === "1"){
                                            
                                            whichServiceCollector.stop()
                                            
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productLimitedItemsAccounts.map(product =>`**[${productLimitedItemsAccounts.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                        ...
                                        else if(collectorContent === "food" || collectorContent === "3"){
                                            
                                            whichServiceCollector.stop()
                                            
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productFoodAccounts.map(product =>`**[${productFoodAccounts.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productFoodAccounts.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
                                        ...
                                        else if(collectorContent === "vpn" || collectorContent === "4"){
                                            
                                            whichServiceCollector.stop()
                                            
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productVpnAccounts.map(product =>`**[${productVpnAccounts.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productVpnAccounts.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
                                        ...
                                        else if(collectorContent === "others" || collectorContent === "5"){
                                            
                                            whichServiceCollector.stop()
                                            
                                            message.channel.send(`*Please make sure to check the store to get a full list of all our products here: https://zestras.net/*\n\n*Select the product that you would like to buy:*\n\n${productOtherAccounts.map(product =>`**[${productOtherAccounts.indexOf(product) + 1}]** *${product.name}* (**$${product.price.toFixed(2)}**)`).join("\n")}\n\n*Please check what stock is available on the shop before picking a product.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                            ...
                                            productCollector.on("collect", (message) => {
                                                ...
                                                if(number.toString() === "NaN") return;
                                                else if(number < 1 || number > productOtherAccounts.length) return message.channel.send(`*Please send a valid number.* **${number}** *is not a valid number.*\n\n**NOTE:** Type \`-close\` to close the ticket at any time.`)
                                                else {
                                                    productCollector.stop();
    ...
    "name": "buy",
    "aliases": ["purchase"],
    "description": "Make a ticket to purchase a product."
};